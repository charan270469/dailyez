...
import { Diamond, TrendingUp, TrendingDown, ArrowUpRight, ArrowDownRight, Megaphone, User, AlertCircle, ChevronRight } from 'lucide-react';
  ...
  return (
    <div className="flex-1 overflow-y-auto no-scrollbar pb-10">
      <div className="mb-8 shrink-0">
        <h2 className="text-[28px] font-bold text-white mb-1.5 tracking-tight">Analytics</h2>
        <p className="text-gray-400 text-sm">Insights and trends across your 12 active signals</p>
      </div>
      ...
      <div className="grid grid-cols-4 gap-6 mb-6">
        <div className="bg-[#161616] border border-[#2a2a2a] rounded-xl p-5 flex flex-col justify-between">
          ...
          <div className="flex items-baseline justify-between">
            ...
            <span className="text-emerald-500 text-sm font-medium">+2 this week</span>
          </div>
        </div>
        <div className="bg-[#161616] border border-[#2a2a2a] rounded-xl p-5 flex flex-col justify-between">
          <span className="text-[11px] font-bold tracking-widest text-gray-400 uppercase mb-4 flex items-center">
            <TrendingUp className="w-3.5 h-3.5 mr-2 text-gray-500" /> TOTAL MATCHES (24H)
          </span>
          <div className="flex items-baseline justify-between">
            <span className="text-3xl font-bold text-white">1,428</span>
            <span className="text-emerald-500 text-sm font-medium flex items-center"><ArrowUpRight className="w-3.5 h-3.5 mr-0.5" /> 12%</span>
          </div>
        </div>
        <div className="bg-[#161616] border border-[#2a2a2a] rounded-xl p-5 flex flex-col justify-between">
          <span className="text-[11px] font-bold tracking-widest text-gray-400 uppercase mb-4 flex items-center">
          ...
          <div className="flex items-baseline justify-between">
            <span className="text-3xl font-bold text-white">4.2 <span className="text-xl text-gray-500 font-medium">min</span></span>
            <span className="text-emerald-500 text-sm font-medium flex items-center"><ArrowDownRight className="w-3.5 h-3.5 mr-0.5" /> 0.8m</span>
          </div>
        </div>
        <div className="bg-[#161616] border border-[#2a2a2a] rounded-xl p-5 flex flex-col justify-between">
          <span className="text-[11px] font-bold tracking-widest text-gray-400 uppercase mb-4 flex items-center">
      ...
      <div className="grid grid-cols-3 gap-6 mb-6">
        <div className="col-span-2 bg-[#161616] border border-[#2a2a2a] rounded-xl p-6">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex items-center space-x-2 text-xs font-semibold bg-[#111] border border-[#2a2a2a] p-1 rounded-lg">
              <button className="px-3 py-1.5 text-gray-400 rounded-md">7D</button>
              <button className="px-3 py-1.5 text-indigo-400 bg-indigo-500/10 rounded-md">30D</button>
            </div>
          </div>
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={signalVolumeData} margin={{ top: 10, right: 0, left: 0, bottom: 0 }}>
                <defs>
                ...
                <XAxis dataKey="day" axisLine={false} tickLine={false} tick={{ fill: '#666', fontSize: 10, fontWeight: 600 }} dy={10} />
        ...
        <div className="bg-[#161616] border border-[#2a2a2a] rounded-xl p-6 flex flex-col">
          <h3 className="text-white font-semibold text-lg mb-6">Platform Distribution</h3>
          <div className="h-48 relative flex-1">
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none flex-col">
              ...
              <span className="text-[10px] font-bold tracking-wider text-gray-500 mt-1 uppercase">Total Hits</span>
            </div>
          </div>
      ...
      <div className="bg-[#161616] border border-[#2a2a2a] rounded-xl overflow-hidden">
        <div className="flex justify-between items-center p-6 border-b border-[#2a2a2a]">
          <h3 className="text-white font-semibold text-lg">Top Performing Signals</h3>
              ...
              <tr className="hover:bg-[#1a1a1a] transition-colors">
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                    ...
                    <span className="font-semibold text-gray-200">Project Alpha</span>
                  </div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <span className="bg-[#222] border border-[#333] text-gray-400 text-[11px] font-semibold px-2.5 py-1 rounded">Discord</span>
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-gray-300">412</td>
              ...
              <tr className="hover:bg-[#1a1a1a] transition-colors">
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                    ...
                    <span className="font-semibold text-gray-200">CEO Office</span>
                  </div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <span className="bg-[#222] border border-[#333] text-gray-400 text-[11px] font-semibold px-2.5 py-1 rounded">Gmail</span>
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-gray-300">24</td>
                <td className="px-6 py-4 whitespace-nowrap text-right">
                  <span className="flex items-center justify-end text-emerald-500 text-sm font-medium">
              ...
              <tr className="hover:bg-[#1a1a1a] transition-colors">
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                    ...
                    <span className="font-semibold text-gray-200">Urgent Fix</span>
                  </div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <span className="bg-[#222] border border-[#333] text-gray-400 text-[11px] font-semibold px-2.5 py-1 rounded">Slack</span>
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-gray-300">86</td>
                <td className="px-6 py-4 whitespace-nowrap text-right">
